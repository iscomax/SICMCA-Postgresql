...
<body>
    ...
    ?>
     ...
     <div class="container-fluid title">
         <div class="row">
             <div class="col-12">
                 <h1 ><i class="bi bi-journal-text me-3"style="font-size: 30px;"></i>Bitácora de Actividades</h1>
            </div>
        </div>
    </div>
  <!----Contenido---->
            ...
            <div class="row">
                <div class="col">
                    <div class="container table-gruposBox">
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title text-center" id="exampleModalLabel">Gráfica Bitácora</h5>
                                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close">
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="container"  id="grafica1"style="width=50%; height:50vh;">
                                    </div>
                                </div>
                        ...
                        <table id="tablaBitacora" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php
                                try {
                                    foreach ($usuarioReporte  as $key => $usuario) {
                                        echo '
                                        <tr>
                                        <td>' . $usuario["shortname"] . '</td>
                                        <td>' . $usuario["fullname"] . '</td>
                                        <td>' . $usuario["groupname"] . '</td>
                                        <td>' . $usuario["username"] . '</td>
                                        <td>' . $usuario["lastname"] . '</td>
                                        <td>' . $usuario["firstname"] . '</td>
                                        <td>' . $usuario["calificacion"] . '</td>
                                        <td>' . $usuario["maxcalificacion"] . '</td>
                                        <td>' . $usuario["email"] . '</td>
                                        <td>' . $usuario["ultimo_acceso"] . '</td>
                                        <td>' . $usuario["diferencia"] . '</td>
                                        <td>
                                        <a href="../administrador/mostrarBitacora.php?id_usuario=' . $usuario['id_usuario'] . '&id_persona=' . $usuario['id_persona'] . '" class="btn btn-primary mt-1 mb-2" type="button">Mostrar</a>
    ...
    <!-- código JS propìo-->    
    <script type="text/javascript" src="../js/tablaBitacora.js"></script>
