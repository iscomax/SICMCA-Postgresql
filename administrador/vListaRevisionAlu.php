...
<head>
    ...
    <title>Revisión de Alumnos</title>
...
<body>
    ...
    <div class="container-fluid">
            <div class="row contenedor-enlaces">
                <div class="col">
                    <h1 class="text-center">Revisión de Alumnos</h1>
                    <div class="container table-gruposBox">
                        <!--Botón Modal-->
                        <button class="btn btn-outline-primary m-4" data-bs-toggle="modal" data-bs-target="#contenedor-modal">Estadísticas</button>
                        <!--Moodal content-->
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title text-center" id="exampleModalLabel">Gráfica Revisión de Alumnos</h5>
                                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close">
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="container"  id="graficaR"style="width=50%; height:50vh;">
                                    </div>
                                </div>
                        ...
                        <table id="tablaRevision" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                ...
                                //print_r($riesgoDesercion);
                                 foreach ($riesgoDesercion as $key => $dato) {
                                      ...
                                      $valor12 = $dato[12];                             
                                        ...
                                        <td>' . $valor12. '</td>
                                        <td>
                                        <a href="estrategia.php?id_usuario=' . $usuario['id_usuario'] . '&id_persona=' . $usuario['id_persona'] . '" class="btn btn-outline-success" type="button">Nueva Estrategia</a>
    ...
    <script src="https://cdn.jsdelivr.net/npm/highcharts-drilldown@0.1.7/drilldown.js"></script>  
     <!-- código JS propìo-->    
     <script type="text/javascript" src="../js/tablaRevision.js"></script>
