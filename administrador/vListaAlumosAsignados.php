...
<head>
    ...
    <div class="container-fluid title">
        <div class="row">
            <div class="col-12">
                <h1 ><i class="bi bi-people-fill me-3"style="font-size: 40px;"></i>Indicador Tareas Enviadas</h1>
            </div>
        </div>
    </div>
  <!----Contenido---->
    <div class="container-fluid">
            <div class="row">
                <div class="col">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title text-center" id="exampleModalLabel">Gráfica Tareas Enviadas</h5>
                                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close">
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <div class="container"  id="graficaAluAsig"style="width=50%; height:50vh;">
                                    </div>
                                </div>
                    ...
                    <table id="tablaAluAsig" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                        <thead>
                            <!--id="tabla"-->
                            <tr>
                                <th>Id</th>
                        ...
                        <tbody>
                            <?php
                            //print_r($listaAlumnosAsig);
                            foreach ($listaAlumnosAsig  as $key => $dato) {
    ...
    <script src="https://cdn.datatables.net/buttons/2.1.1/js/buttons.colVis.js"></script>
     ...
     <!-- código JS propìo-->    
     <script type="text/javascript" src="../js/tablaListaAluAsig.js"></script>
