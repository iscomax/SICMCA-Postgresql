...
<head>
    ...
    <title>Estrategias Registradas</title>
...
<div class="container-fluid title">
     <div class="row">
          <div class="col-12">
               <h1 ><i class="bi bi-list-ol me-3"style="font-size: 40px;"></i>Estrategias Registradas</h1>
          </div>
     </div>
</div>
  <!--------------Contenido------------------>
    <div class="container-fluid">
            <div class="row">
                <div class="col">
                    ...
                    <a href="estrategia.php" class="btn btn-outline-success" role="button"><i class="bi bi-plus-circle-fill me-2"></i>Nueva Estrategia</a>
                    <!--Botón Modal-->
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title text-center" id="exampleModalLabel">Gráfica Seguimiento</h5>
                                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close">
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <div class="container"  id="graficaS"style="width=50%; height:50vh;">
                                    </div>
                                </div>
                    ...
                    <table id="tablaSeguimiento" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                        <thead>
                            <!--id="tabla"-->
                            <tr>
                                <th>Id</th>
                        ...
                        <tbody>
                            <?php
                            foreach ($listaEstrategia as $key => $dato) {
                                $id = $dato['id'];
                                $nombreEstrategia = $dato[2];
                                $alumno = $dato['alumno'];
                                $medio = $dato['descripcion'];
                                $estatus = $dato['descrip'];
                                $profesor = $dato['profesor'];
                                $fechaCaptura = $dato['fechaCaptura'];
                                echo '
                                <tr>
                                <td>' . $id . '</td>
                                <td>' . $nombreEstrategia . '</td>
                                <td>' . $alumno . '</td>
                                <td>' . $medio . '</td>
                                <td>' . $estatus . '</td>
                                <td>' . $profesor . '</td>
                                <td>' . $fechaCaptura . '</td>
                                <td>
                                        <a href="listaHistorialAlumno.php?id_usuario=' . $usuario['id_usuario'] . '&id_persona=' . $usuario['id_persona'] . '&correo='.$alumno .'" class="btn btn-primary mt-1 mb-2" type="button">Historial</a>
    ...
    <script src="https://cdn.datatables.net/buttons/2.1.1/js/buttons.colVis.js"></script>
     ...
     <!-- código JS propìo-->    
     <script type="text/javascript" src="../js/tablaListaEstrategias.js"></script>
