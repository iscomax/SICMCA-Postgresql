...
<head>
    ...
    <title>Profesores por Curso</title>
...
<body>
   ...
   <div class="container-fluid title">
        <div class="row">
            <div class="col-12">
                <h1 ><i class="bi bi-people-fill me-3"style="font-size: 40px;"></i>Profesor por Curso</h1>
            </div>
        </div>
    </div>
  <!----Contenido---->
            ...
            <div class="row">
                <div class="col">
                    <div class="container table-gruposBox">
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title text-center" id="exampleModalLabel">Gráfica Profesor por Curso</h5>
                                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close">
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="container"  id="graficaProfeMat"style="width=50%; height:50vh;">
                                    </div>
                                </div>
                        ...
                        <table id="tablaProfeMat" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php
                                //print_r($profesoresMateria);
                                 foreach ( $profesoresMateria  as $key => $dato) {
                                      $valor0 = $dato[0];
                                      $valor1 = $dato[1];
                                      $valor2 = $dato[2];
                                      $valor3 = $dato[3];                                           
    ...
    <script src="https://cdn.datatables.net/buttons/2.1.1/js/buttons.colVis.js"></script>
     <!-- código JS propìo-->    
     <script type="text/javascript" src="../js/tablaProfeMat.js"></script>
