...
<body>
    ...
    <div class="container-fluid title">
        <div class="row">
            <div class="col-12">
                <h1 ><i class="bi bi-person-lines-fill me-3"style="font-size: 40px;"></i>Historial</h1>
            </div>
        </div>
    </div>
  <!----Contenido---->
            ...
            <div class="row">
                <div class="col">
                    <div class="container table-gruposBox">
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title text-center" id="exampleModalLabel">Gráfica Historial</h5>
                                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close">
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="container"  id="graficaHA"style="width=50%; height:50vh;">
                                    </div>
                                </div>
                        ...
                        <table id="tablaHistorialAlu" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>Id</th>
                            ...
                            <tbody>
                            <?php
                            foreach ($listaEstrategiaIndividual as $key => $dato) {
                                $id = $dato['id'];
                        ...
                        <div class="d-grid gap-2 col-2 mx-auto mt-2">
                            <a class="btn btn-primary" href="listaEstrategias.php" role="button">Regresar</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="https://code.highcharts.com/modules/series-label.js"></script>
     <!-- código JS propìo-->    
     <script type="text/javascript" src="../js/tablaHistorialAlu.js"></script>
    </body>
</html>