...
<body>
    ...
    <div class="container-fluid title ">
        <div class="row">
            <div class="col-12">
                    <h1 ><i class="bi bi-person-lines-fill me-3"style="font-size: 40px;"></i>Lista de Usuarios</h1>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        {
            var resultado = window.confirm('¿Está seguro de eliminar a este usuario?');
            var temporal;
            if (resultado === true) {
                ...
                $.ajax({
                    ...
                    swal("OK...", "El usuario ha sido eliminado con éxito", "success");
                    setTimeout("location.reload(true);", 2000);
                    //location.reload();
                    } else {
                        swal("UPS...","Se ha cancelado la eliminación del usuario", "info");
    ...
    <!-- código JS propìo-->    
    <script type="text/javascript" src="./js/tablaUsuarios.js"></script>
