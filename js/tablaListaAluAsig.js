$(document).ready(function() {
     var tablaAluAsig=$('#tablaAluAsig').DataTable({
   ...
   var graficaAluAsig = $('#graficaAluAsig');
   ...
   var chart = Highcharts.chart(graficaAluAsig[0], {
       chart: {
           type: 'pie',
       },//tipo de gráfica
       title: {
           text: 'Tareas Pendientes por Calificar',
       },
    ...
    tooltip: {
        headerFormat: 'Tareas Pendientes por Calificar'
      },
    ...
    plotOptions: {
       ...
       series: [{
           ...
           dataSorting: {
            enabled: true},  
           colorByPoint: true,
           data: chartData(tablaAluAsig)//llamada a los datos almacenados
       }]
 
   });
 
 //función chartData
 function chartData(tablaAluAsig) {
     var filasAfectadas = {};//inicializacion de la variable para el conteo de las filas afectadas
     tablaAluAsig.column(10, {
