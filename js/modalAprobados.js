/* ponemos la tabla en una variable */
$(document).ready(function () {
    var tablaGrupo = $('#reporteAprobados').DataTable({
        responsive: true,
        dom: 'Bfrtilp',
    ...
    var container = $('#graficaAprodados');
    ...
    var chart = Highcharts.chart(container[0], {
        ...
        xAxis: {
            ...
            categories: ['Pendientes', 'Calificación 6', 'Calificación 7', 'Calificación 8', 'Calificación 9', 'Calificación 10']
        },
        yAxis: {
            title: {
