$(document).ready(function() {
    var tablaDes=$('#tablaDesercion').DataTable({
  ...
  var chart = Highcharts.chart(graficaD[0], {
      chart: {
          type: 'column',
      },//tipo de gráfica
      title: {
   ...
   plotOptions: {
      ...
      series: [{
          ...
          dataSorting: {
            enabled: true},  
          colorByPoint: true,
          data: chartData(tablaDes)//llamada a los datos almacenados
      }]

  });

//función chartData
function chartData(tablaDes) {
