$(document).ready(function() {
    var tablaMostrarB=$('#tablaMostrarB').DataTable({
         ...
         buttons:[ 
          {
              ...
              messageTop: 'Bitácora individual',
 ...
 Highcharts.setOptions({
  ...
  var chart = Highcharts.chart(graficaMB[0], {
      chart: {
          type: 'pie',
      },//tipo de gráfica
      title: {
   ...
   plotOptions: {
      ...
      series: [{
          ...
          dataSorting: {
            enabled: true},  
          colorByPoint: true,
          data: chartData(tablaMostrarB)//llamada a los datos almacenados
      }]

  });

//función chartData
function chartData(tablaMostrarB) {
    var filasAfectadas = {};//inicializacion de la variable para el conteo de las filas afectadas
    tablaMostrarB.column(3, {
