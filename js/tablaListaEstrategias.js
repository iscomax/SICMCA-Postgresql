$(document).ready(function() {
    var tablaSeguimiento=$('#tablaSeguimiento').DataTable({
         ...
         buttons:[ 
          {
              ...
              messageTop: 'Lista de Estrategias',
              title: 'Universidad Nacional Autónoma de México ',
              exportOptions: { 
                columns:':visible' //columns: [ 0, 1, 2, 3,4,5,6] 
              },
 ...
 Highcharts.setOptions({
  ...
  var chart = Highcharts.chart(graficaS[0], {
      chart: {
          type: 'column',
      },//tipo de gráfica
      title: {
   ...
   tooltip: {
       headerFormat: 'Estrategia de Tipo',
       pointFormat: '<span style="color:{point.color}">\u25CF</span> <b> {point.name}</b><br/>' +
         'Total de Notificaciones: <b>{point.y}</b><br/>'
     },
   ...
   plotOptions: {
      ...
      series: [{
          ...
          dataSorting: {
            enabled: true},
          data: chartData(tablaSeguimiento)//llamada a los datos almacenados
      }]

  });

//función chartData
function chartData(tablaSeguimiento) {
    var filasAfectadas = {};//inicializacion de la variable para el conteo de las filas afectadas
    tablaSeguimiento.column(1, {
