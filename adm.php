...
include_once('./administrador/script.php');
...
{  
   ...
   // echo "vacio ";
    ...
    if ( isset($_POST['id_usuario']) && isset($_POST['id_persona'])) {
        ...
        echo $conexion->eliminarRol($id_usuario);
        echo $conexion->eliminarUsuario($id_usuario);
        echo $conexion->eliminarPersona($id_persona);
